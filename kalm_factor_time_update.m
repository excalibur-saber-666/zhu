function [Xc,PK,Xerr] = kalm_factor_time_update(t,T_D,Fb,attiN,veloN,posiN,Xc,PK,Xerr)
%进行导航系统的时间更新
  ...
  W=[10*pi/(3600*180),10*pi/(3600*180),10*pi/(3600*180), ...
     sqrt(2*T_D/Tgx)*10*pi/(3600*180),sqrt(2*T_D/Tgy)*10*pi/(3600*180),sqrt(2*T_D/Tgz)*10*pi/(3600*180), ...
     sqrt(2*T_D/Tax)*(1e-3)*g,sqrt(2*T_D/Tay)*(1e-3)*g,sqrt(2*T_D/Taz)*(1e-3)*g]';  
