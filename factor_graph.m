...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = factor_graph(x,Xerr)     %以初始时刻的先验信息初始化，有个先验因子
        ...
        function factor_add(obj,J,b,k1)     %这里需要注意obj算输入个数！！k1代表节点标号,flag表示是锚节点还是移动节点
            obj.d = [obj.d;b];
        ...
        function Gauss_Newton(obj,posi_1,Xerr,distance)
            n_iters = 50;
            thresh  = 1e-5;
            for i = 1:n_iters
                [Q,R] = qr(obj.A);
...
%                            obj.A(1:3,1:3) = sqrt_info * Jaco_prior;
                       ...
                       case 2
                           ...
                           [residual,jaco] = residual_cal(Pi,Pj,distance(1,k1-1));
        ...
        function Levenberg_M(obj,posi_1,Xerr,distance)
